...
#define FOREACHSHIFT4_0(MACRO,COUNT,ARGS...) MACRO(0,OOOIsEmpty(OOOPost(ARGS)),4,COUNT,OOOPre(COUNT,ARGS),OOOSimplePaste(FOREACHSHIFT5_,OOOIsEmpty(OOOPost(ARGS)))(MACRO,OOOPost(ARGS)))
#define FOREACHSHIFT4_1(MACRO,ARGS...)
#define FOREACHSHIFT3_0(MACRO,COUNT,ARGS...) MACRO(0,OOOIsEmpty(OOOPost(ARGS)),3,COUNT,OOOPre(COUNT,ARGS),OOOSimplePaste(FOREACHSHIFT4_,OOOIsEmpty(OOOPost(ARGS)))(MACRO,OOOPost(ARGS)))
#define FOREACHSHIFT3_1(MACRO,ARGS...)
#define FOREACHSHIFT2_0(MACRO,COUNT,ARGS...) MACRO(0,OOOIsEmpty(OOOPost(ARGS)),2,COUNT,OOOPre(COUNT,ARGS),OOOSimplePaste(FOREACHSHIFT3_,OOOIsEmpty(OOOPost(ARGS)))(MACRO,OOOPost(ARGS)))
#define FOREACHSHIFT2_1(MACRO,ARGS...)
#define FOREACHSHIFT1_0(MACRO,COUNT,ARGS...) MACRO(0,OOOIsEmpty(OOOPost(ARGS)),1,COUNT,OOOPre(COUNT,ARGS),OOOSimplePaste(FOREACHSHIFT2_,OOOIsEmpty(OOOPost(ARGS)))(MACRO,OOOPost(ARGS)))
#define FOREACHSHIFT1_1(MACRO,ARGS...)
#define FOREACHSHIFT0_0(MACRO,COUNT,ARGS...) MACRO(1,OOOIsEmpty(OOOPost(ARGS)),0,COUNT,OOOPre(COUNT,ARGS),OOOSimplePaste(FOREACHSHIFT1_,OOOIsEmpty(OOOPost(ARGS)))(MACRO,OOOPost(ARGS)))
#define FOREACHSHIFT0_1(MACRO,ARGS...)
#define FOREACHSHIFT(MACRO,ARGS...) OOOSimplePaste(FOREACHSHIFT0_,OOOIsEmpty(ARGS))(MACRO,ARGS)
