...
OOOTest(OOOPost)
{
	...
	szTest = OOOQuote(OOOPost(OOOCount(EMPTY)));
	...
	szTest = OOOQuote(OOOPost(OOOCount(EMPTY), ARGS_10));
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_1), ARGS_1));
	if (O_strcmp(EMPTY_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", EMPTY_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_1), ARGS_1, ARGS_10));
	if (O_strcmp(ARGS_10_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", ARGS_10_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_2), ARGS_2));
	if (O_strcmp(EMPTY_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", EMPTY_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_2), ARGS_2, ARGS_10));
	if (O_strcmp(ARGS_10_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", ARGS_10_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_3), ARGS_3));
	if (O_strcmp(EMPTY_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", EMPTY_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_3), ARGS_3, ARGS_10));
	if (O_strcmp(ARGS_10_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", ARGS_10_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_10), ARGS_10));
	if (O_strcmp(EMPTY_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", EMPTY_RESULT, szTest);
	}
	...
	szTest = OOOQuote(OOOPost(OOOCount(ARGS_10), ARGS_10, ARGS_10));
	if (O_strcmp(ARGS_10_RESULT, szTest) != 0)
	{
		OOOError("expected: %s\nReceived: %s", ARGS_10_RESULT, szTest);
	}
